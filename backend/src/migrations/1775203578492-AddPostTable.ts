...
export class AddPostTable1775203578492 implements MigrationInterface {
    name = 'AddPostTable1775203578492'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "comment_like" ("id" SERIAL NOT NULL, "commentId" integer NOT NULL, "userId" integer NOT NULL, CONSTRAINT "PK_04f93e6f1ace5dbc1d8c562ccbf" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_5ddb528d11dfb6fdc09e623907" ON "comment_like" ("commentId", "userId") `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_5ddb528d11dfb6fdc09e623907"`);
